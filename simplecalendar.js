...
class SimpleCalendar {
    constructor(containerId, events, options = {}) {
        ...
        this.options = Object.assign({
            ...
            eventContent: null,
            pdf: {
                programFilename: 'Conference_Program',
                calendarFilename: 'Conference_Calendar',
                margin: 15,
                overlayMargin: 5,
                overlayOpacity: 0.85,
...
renderTimesColumn() {
    ...
    updatePdfButtonState() {
        ...
        btn.innerHTML = this.isGeneratingPdf
            ? `
        <div role="status" class="flex items-center justify-center h-5 w-5">
            <svg aria-hidden="true"
                 class="h-5 w-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                 viewBox="0 0 100 101"
...
`;
    ...
    async generatePdf() {
        ...
        try {
            ...
            pdf.save((this.options?.pdf?.calendarFilename ?? 'Conference_Calendar') + '.pdf');
